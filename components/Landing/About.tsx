        ...
        <div className="grid grid-cols-1 mt-8 md:mt-20 gap-y-6 md:grid-cols-2 gap-x-10">
          ...
          <div>
            ...
            <p className="mt-4 text-lg">
              I&apos;m a passionate web developer with an entrepreneurial spirit
              for building cool things! My biggest wish to leverage the latest
              technology to substantially improves peoples lives.
            </p>
            <p className="mt-4 text-lg">
              I am addicted to programming and working with people to understand
              them at a deep level. I recieved my Bachlor&apos;s and
              Master&apos;s from Brigham Young University. I started building
              Quizzzard AI because I recalled the rigors of studying for exams
              in college and want to help others in their educational journey.
            </p>
            ...
            <p className="mt-4 text-lg">
              At this time, Quizzzard AI is fully self-funded. I&apos;m
              extremely picky on how I spend money in my business so I am able
              to keep costs relatively low for the time being. As Quizzzard
              AI&apos;s features expand and grow in complexity, I plan to
              receive funding and start charging for the product eventually.
            </p>
          </div>
        </div>
      </div>
